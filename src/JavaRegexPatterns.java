 ...
 * Author: Qi Huang
 * Date: 2017/12/11
 * Purpose: Some regular expression patterns for java
 */
public class JavaRegexPatterns {

    // prevent from create this static utility class
    private JavaRegexPatterns() {}
    ...
    public static final Pattern WEB_URL = Pattern.compile(
            "((?:(http|https|Http|Https|rtsp|Rtsp):\\/\\/(?:(?:[a-zA-Z0-9\\$\\-\\_\\.\\+\\!\\*\\'\\(\\)"
                    ...
                    + "\\-\\.\\+\\!\\*\\'\\(\\)\\,\\_])|(?:\\%[a-fA-F0-9]{2}))*)?"
                    + "(?:\\b|$)"); // finally, a word boundary or end of input.This is to stop foo.sure from matching as foo.su
